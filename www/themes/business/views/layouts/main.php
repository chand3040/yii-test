...
<body class="drg-body art-<?php echo Yii::app()->controller->id; ?>"
      style="width: 1025px; position: relative; margin: 0px auto;">
...
<div id="loading-div" style="display: none;">
    ...
    <img style="margin: 25%;" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/loader.gif" alt="loading"
         title="loading image"/>
...
<div id="shadow-wrap">
    ...
    */
    ...
    else if (Yii::app()->controller->id == 'listing' && in_array(Yii::app()->controller->action->id, array('rejection', 'publish', 'rdelete', 'suspension', 'restore')) && Yii::app()->user->isGuest) {
    ...
    else if (Yii::app()->controller->id == 'mymessages' && in_array(Yii::app()->controller->action->id, array('index')) && Yii::app()->user->isGuest){
    ?>
...
<?php if (Yii::app()->controller->id == 'search') { ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#login-area li span').css({'width': '150px'});
            $('#tabs li a').css({'width': '45%'});
