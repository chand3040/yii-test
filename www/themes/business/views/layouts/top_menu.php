      ...
      <div id="menuh">
        ...
        $this->widget('zii.widgets.CMenu',array(
            'items'=>array(         
                ...
                array('label'=>'business services', 'url'=>array('/businesslisting/businesslisting/business_services'),'active'=>(Yii::app()->controller->module->id=='businesslisting' && Yii::app()->controller->id=='businesslisting' && Yii::app()->controller->action->id=='business_services')),              
            ),
        ));     
        $this->widget('zii.widgets.CMenu',array(
            'items'=>array(
		...
		array('label'=>'my account', 'url'=> Yii::app()->user->_user_Type=='user' ? array('/user/myaccount/update'):array('/business/myaccount/update'),'active'=>(Yii::app()->controller->id=='banner' || Yii::app()->controller->id=='businesslisting' || Yii::app()->controller->id=='listing' && Yii::app()->controller->action->id=='index' || Yii::app()->controller->id=='listing' && Yii::app()->controller->action->id=='create' || Yii::app()->controller->id=='listing' && Yii::app()->controller->action->id=='selectlisting' || Yii::app()->controller->id=='listing' && Yii::app()->controller->action->id=='sample_listing' || Yii::app()->controller->id=='listing' && Yii::app()->controller->action->id=='user_listing_step2' || Yii::app()->controller->id=='listing' && Yii::app()->controller->action->id=='user_listing_step3' || Yii::app()->controller->id=='listing' && Yii::app()->controller->action->id=='user_listing_step4' || Yii::app()->controller->id=='myaccount')),           
                ),
            ));
        }
         /*
