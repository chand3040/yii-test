...
<div class="u-email-box banner-email-box" style="margin:100px auto;width:450px">
               ...
               <div class="my-account-popup-box banner-account-popup">
                    ...
                    ?> 
                        ...
                        <div id="login-area"><!--login form -->  
                                             ...
                                             <span> Please Enter your username and password To continue </span><br/> <br/>
                                  
                        <form action="<?php echo Yii::app()->createUrl('/guestlogin'); ?>" method="post" name="login_form" id="login_form" onsubmit="return false" />
                           ...
                           <input onblur="if(this.value=='')this.value='Username'" onfocus="check_user_info(this.id);" type="text" name="user_default_username" title="Please enter your username"  value="<?php if(isset($_COOKIE['username'])!=''){ echo $_COOKIE['username']; } else { echo "Username"; } ?>" id="user_default_username" size="20"  />
                            ...
                            <div id="passwordbox">
                                ...
                                <input name="redirectto" id="redirectto" value="<?php echo $_GET['redirectto']; ?>" type="hidden" />
                            ...
                            <div class="sign-option">
                                <ul>
                                    ...
                                    <li>
                                            ...
                                            <a class=" lpa" href="javaScript:void(0)" onclick="show_lost_pass_form()"  title='Reset your password'> <span style="float:right">Lost your password</span>
                                     ...
                                     <li>
                                            ...
                                            <button style="float:right" class=" button black" name="login_sbmt" type="submit" title='Log into your account'>Continue </button>
             ...
             $('form#login_form').submit(function(ev){
                      ...
                      var failedvalidation = false;
                        ...
                        if(failedvalidation==false)
                        {
                             ...
                             $.ajax({
                                 type: "POST",
                                 url: "<?php echo Yii::app()->createUrl('site/guestlogin');?>",
                                 async: false,
                                 data: 'LoginForm[username]='+drf_name+'&LoginForm[password]='+drf_pass+'&YII_CSRF_TOKEN=<?php echo Yii::app()->request->csrfToken; ?>&redirectto='+redirectto,
