  ...
  <div id="leftcontent"> <!-- slider-wrapper start -->
    ...
    <div class="sign-up-tabss"> <!-- start sign up tab -->
      ...
      <div id="tabs_container">
        <ul id="sign-up-tabs">
          <li class="active"> <a href="#taba" title="Full list of ALL Industrial Ideas entries">Industrial<br/>
            ( 999,999,999 )</a> </li>
        ...
        <div id="taba" class="sign-up-tab_content" style="display: block;">
          <table border="0" bordercolor="#fff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">
            <tr class="tableHeading">
              ...
              <td><select id="sl_lookfor" name="drg_lookfor" data-placeholder="Looking for..." class="chzn-select" style="width:120px;" tabindex="2">
                  <option value=""></option>
