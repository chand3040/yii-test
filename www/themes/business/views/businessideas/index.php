...
<div class="sign-up-tabss"> <!-- start sign up tab -->
  ...
  <div id="tabs_container">
    <ul id="sign-up-tabs">
      <li class="active"> <a href="#taba" title="Full list of ALL Business Ideas entries">Business ideas<br/>
        ( 999,999,999 )</a> </li>
      <li> <a href="#tab2" title="Listings under promotion">Promotions <br/>
        ( 8 )</a> </li>
      <li> <a href="#tab3" title="Businesses offering samples for market testing">Product samples<br/>
        ( 9 )</a> </li>
      <li> <a href="#tab4" title="My favourite industrial listings">My favourites<br/>
        ( 1 )</a> </li>
      <li> <a style="color:#808080; cursor: default;" href="#tab5" title="Businesses open for sale">Auction<br/>
        ( 0 )</a> </li>
      <li> <a style="color:#808080; cursor: default;" href="#tab6" title="Businesses open for investment">Open for investment<br/>
        ( 0 )</a> </li>
    </ul>
    <div class="clear"></div>
  </div>
  ...
  <div id="tabs_content_container"> 
    ...
    <div id="taba" class="sign-up-tab_content" style="display: block;">
      <table border="" bordercolor="#ffffff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">
        <tr class="tableHeading">
          <td title="Sort in date order"><select option value="Date" data-placeholder="Date" class="chzn-select" style="width:80px;">
          ...
          <!-- Arrange date order -->
          <td title="Sort in title order"><select data-placeholder="Title" class="chzn-select" style="width:110px;">
              <option value="" label="Select" title="Select option"></option>
          ...
          <td><select class="sl_lookfor chzn-select" name="drg_lookfor" data-placeholder="Looking for..." style="width:120px;" tabindex="2">
              <option value="" label="Select" title="Select option"></option>
              <option value="All">All</option>
              <option <?php if ($drg_lookfor == 'Funding') {
                echo "selected='selected'";
            } ?> value="Funding" title="Are you looking for funding?">Funding </option>
              <option <?php if ($drg_lookfor == 'Franchise') {
                echo "selected='selected'";
            } ?>  value="Franchise" title="Are you looking to expand your business?">Franchise </option>
              <option <?php if ($drg_lookfor == 'Investor') {
                echo "selected='selected'";
            } ?>  value="Investor" title="Are you looking for investment?">Investor </option>
              <option <?php if ($drg_lookfor == 'Licensing') {
                echo "selected='selected'";
            } ?>  value="Licensing" title="Do you want to license your idea?">Licensing </option>
              <option <?php if ($drg_lookfor == 'Market Research') {
                echo "selected='selected'";
            } ?>  value="Market Research" title="Want to know if have a demand for your product?">Market Research </option>
              <option <?php if ($drg_lookfor == 'Mentor') {
                echo "selected='selected'";
            } ?>  value="Mentor" title="Are you looking for help?">Mentor </option>
              <option <?php if ($drg_lookfor == 'Partner') {
                echo "selected='selected'";
            } ?>  value="Partner" title="Are you looking for a partner?">Partner </option>
              <option <?php if ($drg_lookfor == 'Skill Set') {
                echo "selected='selected'";
            } ?>  value="Skill Set" title="Are you looking to employ help?">Skill Set </option>
            </select></td>
          <!-- Looking for... -->
          
          <td><?php $data = CHtml::listData(Country::model()->findAll(), 'country_id', 'country'); ?>
      ...
      <table border="" bordercolor="#ffffff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">
        <tr class="tableHeading">
          ...
          <td title="Sort in alphabetical order" style=" background-clip: padding-box;
                                ...
                                position: relative;
                                text-decoration: none;
                                white-space: nowrap; margin-top:4.5px; ">Details </td>
          <td title="Points offered"><select data-placeholder="Points" class="chzn-select" style="width:76px;">
              <option value="" label="Select" title="Select option"></option>
    ...
    onclick="DoNav('<?php echo Yii::app()->getBaseUrl(true); ?>/users/Jaguar/plummate/plummate.php');"
      ...
      <table border="" bordercolor="#ffffff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">
        <tr class="tableHeading">
          ...
          <td title="Sort in alphabetical order" style=" background-clip: padding-box;
                                ...
                                position: relative;
                                text-decoration: none;
                                white-space: nowrap; margin-top:4.5px; ">Sample details </td>
          <td title="Sample cost"><select data-placeholder="Cost" class="chzn-select" style="width:85px;">
              <option value="" label="Select" title="Select option"></option>
              <option value="All">All</option>
          ...
          <td title="Sample availability"><select data-placeholder="Availability" class="chzn-select" style="width:110px;">
    ...
    <div id="tab4" class="sign-up-tab_content">
      <table border="" bordercolor="#ffffff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1" cellspacing="2">
        <tr class="tableHeading">
          <td title="Sort in date order"><select data-placeholder="Date" class="chzn-select" style="width:80px;">
              <option value="" label="Select" title="Select option"></option>
              <option value="a_z" title="Sort list in descending order">Latest</option>
              <option value="z_a" title="Sort list in ascending order">Longest</option>
            </select></td>
          ...
          <td><select class="sl_lookfor chzn-select" name="drg_lookfor" data-placeholder="Looking for..." style="width:120px;" tabindex="2">
              ...
              <option <?php if ($drg_lookfor == 'Market Research') {
                        echo "selected='selected'";
                    } ?>  value="Market Research" title="Want to know if have a demand for your product?">Market
              Research </option>
              <option <?php if ($drg_lookfor == 'Mentor') {
                        echo "selected='selected'";
                    } ?>  value="Mentor" title="Are you looking for help?">Mentor </option>
          ...
          <!-- Looking for... -->
          <td><?php  $data = CHtml::listData(Country::model()->findAll(), 'country_id', 'country');?>
            <?php echo CHtml::dropdownlist('drg_country', 'Please Select', $data,array('empty' => 'Worldwide', 'style'=>'width:110px','class'=>'chzn-select'));?></td>
          <!-- Select Country --> 
        </tr>
        <!-- /Table Headings -->
        <tr onmouseover="ChangeColorGrey(this, true);" 
