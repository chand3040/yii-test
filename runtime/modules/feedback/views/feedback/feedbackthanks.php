      ...
      <div class="confirm-email" style="display: block;">
          <div class="u-email-box"> 
            ...
            <div style="margin-top:-38px !important" class="my-account-popup-box"> 
              ...
              <p id="confirm_email_popup" class="orange-color">support@businessinvention.com</p>
    ...
    <div id="cont_back_div" style="display: none;">
        <div id="inner_cont_div">
          <div style="margin:22px auto !important" class="pop-up">
            <h2 align="center"><cufon class="cufon cufon-canvas" alt="businessinvention.com " style="width: 206px; height: 16.8px;"><canvas width="226" height="20" style="width: 226px; height: 20px; top: -2px; left: -2px;"></canvas><cufontext>businessinvention.com </cufontext></cufon><cufon class="cufon cufon-canvas" alt="Terms " style="width: 53px; height: 16.8px;"><canvas width="72" height="20" style="width: 72px; height: 20px; top: -2px; left: -2px;"></canvas><cufontext>Terms </cufontext></cufon><cufon class="cufon cufon-canvas" alt="&amp; " style="width: 16px; height: 16.8px;"><canvas width="36" height="20" style="width: 36px; height: 20px; top: -2px; left: -2px;"></canvas><cufontext>&amp; </cufontext></cufon><cufon class="cufon cufon-canvas" alt="Conditions" style="width: 76px; height: 16.8px;"><canvas width="92" height="20" style="width: 92px; height: 20px; top: -2px; left: -2px;"></canvas><cufontext>Conditions</cufontext></cufon></h2>
            <div class="pop-up-content">
              <div id="pop-up-toc">
                <p>Business Invention.com reserve the right to decide which business idea to add to the database and which business idea not to include. Minor changes may be made to your submissions in order to enhance readability. Nevertheless, it's the submitters (and nobody else) who are responsible for the contents of the ideas published on the businessinvention.com website. businessinvention.com is in no way responsible for the consequences of views expressed or ideas submitted by its users, including but not limited to copyright infringement.</p>
<p>Should you encounter anything annoying on this website, please contact <a href="<?php echo Yii::app()->params['support_email']; ?>">Business Supermarket Customer Support.</a>  is trying to do the best job possible, but if you think it could still be better, we might as well find a solution together.</p>
...
<p>By submitting a business idea to the businessinvention.com website, you dedicate it to the public domain. This means that anyone is free to view it.</p>
...
<p>Any user found to be disrespectable or for which businessinvention.com receives a complaint will have their account barred permanently.</p>
<p>Any complaints or concerns must first be taken up with the lister / member. If no solution can be found then you must summaries the history of the issue including all communications to <a href="<?php echo Yii::app()->params['support_email']; ?>">Business Supermarket Customer Support.</a> ABusiness Supermarket support member will then attempt to resolve the matter based on the information provided.</p>
<p>If you are a legal entity or an individual with legal representation you must first attempt to resolve any issues or grievances with the parties concerned. If you are unsuccessful you may then contact <a href="<?php echo Yii::app()->params['support_email']; ?>">Business Supermarket Customer Support.</a> with proof of your claim for assistance in helping your resolve the matter.</p>
...
<p>You will not:-</p>
    ...
    <ul class="toc-list">
        ...
        <li>fail to deliver payment when requested by businessinvention.com.</li>	 
        <li>interfere with other users listings.</li>
        <li>circumvent or manipulate our fee structure, the billing process or fees owed to businessinvention.com</li> 
        <li>post false, inaccurate, misleading, defamatory or libellous content including personal information on businessinvention.com</li>	
        <li>take any action that may undermine the feedback or ratings systems in anyway.</li>
        <li>Transfer you businessinvention.com account (including content and information) and user ID to another party without our consent.</li> 
