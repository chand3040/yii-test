...
<div>
    <?php
    $this->renderPartial('//../modules/listing/views/layouts/default_slider', array('listing_category_id' => 3));
    ?>
</div>
...
<div id="tabs_container">
    <ul id="sign-up-tabs">
        <li class="active">
            <a href="#taba" title="Full list of ALL Business Ideas entries">Retail<br/>( <?php echo $total_posts; ?>
                )</a>
        </li>
        <li>
...
<div id="taba" class="sign-up-tab_content" style="display: block;">
    ...
    <?php }else{?>
        <table border="0" bordercolor="#fff" style="background-color:#fff; cursor:pointer" width="100%" cellpadding="1"
               cellspacing="2">
            <td class="noteTemp">There are no retail currently available</td>
        </table>
    <?php } ?>
</div>
