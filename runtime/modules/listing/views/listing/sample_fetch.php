...
if( $totalComments > 0 ){
	...
	{
		echo '<img src="' . Yii::app()->createUrl('/assets/c1df49d0/img/star-on.png') . '" />';
	}
?></span>
                        </div>
                        <div class="dd_coment" data-commentid="<?=$commentDetails['comment']->user_default_sample_listing_feedback_id;?>" style="width: 545px;">
                            ...
                            <ul class="dd_coment_heading" style="overflow: visible;">
                                ...
                                if( count($commentDetails['post_comment']) > 0 ){ ?>
                                    ...
                                    <li><a class="tooltip openCloseComments" data-status="closed" style="margin-right: 5px;color:#e5a404;cursor:pointer">Open all threads<span class="classic openCloseCommentsTooltip">Open all threads</span></a></li>
...
<div class="clear"></div>
                            <a class="floatLeft replpToPostComment <?=$grayedOutClass;?>" data-commentid="<?=$commentDetails['comment']->user_default_sample_listing_feedback_id;?>" style="cursor: pointer; font-size:0.8em;">Reply to post</a>
                            ...
                            <div class='postBlock'>
                                <form class="submit-comment sub-text-field hiddenForm replyToPostCommentForm-<?=$commentDetails['comment']->user_default_sample_listing_feedback_id;?>" data-commentreference="<?=$commentDetails['comment']->user_default_sample_listing_feedback_id;?>">
                                       ...
                                       <!-- <div class="submitBtn">--><a class="dd_feedback_post_button" title="Submit comment" >Post</a><!--</div>-->
                                 <br/><br/><br/><?php /* ?>
                            ...
                            foreach ($commentDetails['post_comment'] as $postsComments) {
                               ...
                               <?php /*  <img src="<?=Yii::app()->theme->getBaseUrl().'/images/icons/user.png';?>" width="60px"> */?>
								...
								?>
                                    ...
                                    <div class="like_buuton_box" data-commentid="<?=$postsComments['user_default_sample_listing_feedback_id'];?>" style="margin-right: -22px !important;margin-top: -21px !important;">
            ...
            <div class="user-page-navfeed">
                ...
                <script type="text/javascript"> $(".chzn-select").chosen();</script>
                    ...
                    <!-- Bottom navigation menu -->
                      <div class="page_numbers feedbackPageNumbers">
                          <?php
