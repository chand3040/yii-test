...
<div class="registration-content" style="min-height:580px">
    ...
    <div class="delete_listing black-popup" style="display: none;">
        <div class="delete_listing_popup">
            <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/robot/Robot-pointing-down.png" />
            <div class="my-listing-delete-box">
                <form action="<?php echo Yii::app()->createUrl('listing/delete');?>" method="post">
                    <?php
                    $surll= $_SERVER["REQUEST_URI"];
                    $surll1 = ltrim($surll, '/');
                    ?>
                    <input type="hidden" name="furl" value="<?php echo $surll1; ?>" />
                    <input type="hidden" value="" id="listing_delete_id" name="listing_delete_id" />
                    <span style="font: 25px AuraBoldRegular, Helvetica, Arial;  margin-top: 20px;color: #1dbfd8;display: block;">Delete Listing</span>
                    <br/>   <span>Are you sure you want to Permanently delete this listing from the website?</span>
                    <br/>   <span style="  display: block;font-size: 11px;">
		<i style="color:red;">Warning this action cannot be undone</i></span><br/>
                    <div class="confirmbtn">
                        <button  type="submit" name="deletelisting" class="button black">OK</button>
                        &nbsp;&nbsp;&nbsp;&nbsp;<button class="button black" type="button" onclick="jQuery('.delete_listing').hide();jQuery('#listing_delete_id').val('0');jQuery('.userlistings').fadeIn('slow'); return false;">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="delete_sample black-popup" style="display: none;">
        <div class="delete_listing_popup">
            <img src="<?php echo Yii::app()->theme->baseUrl ?>/images/robot/Robot-pointing-down.png" />
            <div class="my-listing-delete-box">
                <form action="<?php echo Yii::app()->createUrl('listing/sampledelete');?>" method="post">
                    <?php
                    $surll= $_SERVER["REQUEST_URI"];
                    $surll1 = ltrim($surll, '/');
                    ?>
                    <input type="hidden" name="furl" value="<?php echo $surll1; ?>" />
                    <input type="hidden" value="" id="sample_delete_id" name="sample_delete_id" />
                    <span style="font: 25px AuraBoldRegular, Helvetica, Arial;  margin-top: 20px;color: #1dbfd8;display: block;">Delete Sample</span>
                    <br/>   <span>Are you sure you want to Permanently delete this sample from the website?</span>
                    <br/>   <span style="  display: block;font-size: 11px;">
		<i style="color:red;">Warning this action cannot be undone</i></span><br/>
                    <div class="confirmbtn">
                        <button  type="submit" name="deletesamples" class="button black">OK</button>
                        &nbsp;&nbsp;&nbsp;&nbsp;<button class="button black" type="button" onclick="jQuery('.delete_sample').hide();jQuery('#sample_delete_id').val('0');jQuery('.userlistings').fadeIn('slow'); return false;">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div style="float:right; width:625px;" class="userlistings">
        ...
        <table class="gernal_table manageListing" border="0"  style="" width="50%" cellpadding="1" cellspacing="2">
		  ...
		  <?php */ ?>
            <tr class="tableHeading">
                <td class="date_column" style="cursor:default; text-align: center; width:70px;" title="Date published">Submitted</td>
                <td class="title_column" style="cursor:default" title="Listing title">Listing Title</td>
                <td class="title_column" style="cursor:default; width: 130px;" title="Listing title">Type</td>
                <td class="" style="cursor:default; width:35px;" title="Delete listing">Delete</td>
            </tr>
            <?php
            if(!empty($list1)){
                ...
                if($j%2==0){
                    ...
                    <td  onclick="DoNav('<?php echo Yii::app()->createUrl('listing/selectlisting/listid/'.$listData1->user_default_listing_id);?>');" <?php if($j%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?>>0</td>
                    <?php */ ?>
                        <td  onclick="DoNav('<?php echo Yii::app()->createUrl('listing/selectlisting/listid/'.$listData1->user_default_listing_id);?>');" <?php if($j%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?> >Listing</td>
            ...
            $criteria1->compare('user_default_sample_listing_status', 1, true);
            $criteria1->join = "INNER JOIN user_default_listing AS listing ON (listing.user_default_listing_id = t.user_default_listing_id)";
            $criteria1->compare('listing.user_default_profiles_id', Yii::app()->user->getId(), true);
            $criteria1->order = 't.user_default_listing_id desc';
            $count = Samplelisting::model()->count($criteria1);
            $samplemodels = Samplelisting::model()->findAll($criteria1);

            if($count > 0)
            {
                foreach($samplemodels as $samplemodel)
                {

                    $listingid =  $samplemodel->user_default_listing_id;
                    $listingmodel = Userlisting::model()->findByPk($listingid);
                ...
                if($j%2==0){
                    ...
                    <tr class="MauveRow"> <!--style="background-color: rgb(234, 221, 237);"-->
                        ...
                        ?>
                        <td  onclick="DoNav('<?php echo Yii::app()->createUrl('sample/sample_listing/listid/'.$listData1->user_default_listing_id);?>');" <?php if($j%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?>><?php echo $samplemodel->user_default_sample_listing_date;?></td>
                        <td  onclick="DoNav('<?php echo Yii::app()->createUrl('sample/sample_listing/listid/'.$listData1->user_default_listing_id);?>');" <?php if($j%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?>><?php echo $listingmodel->user_default_listing_title;?></td>
                        <td  onclick="DoNav('<?php echo Yii::app()->createUrl('sample/sample_listing/listid/'.$listData1->user_default_listing_id);?>');" <?php if($j%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?> >Sample</td>
                        <td style="text-align: center; background-color: #fff" ><input type="hidden" value="<?php echo $samplemodel->user_default_sample_listing_id; ?>" name="del_samplenew" id="del_samplenew" /><a href="javascript:{}" onclick="delete_samples<?php echo $j; ?>();" title="Delete this sample"  class="delbtnsample<?php echo $j; ?>" id="delbtnnewsample"><img src="themes/business/images/icons/delete.gif" alt="Delete this listing"></a></td>
                    </tr>
                    <script>
                        function delete_samples<?php echo $j; ?>()
                        {
                            jQuery(".delete_sample").fadeIn();
                            jQuery(".userlistings").fadeOut('fast');
                            var lid = $(".delbtnsample<?php echo $j; ?>").parent().find('#del_samplenew').val();
                            $('#sample_delete_id').val(lid);
                        }
                    </script>
                    <?php
                    $j++;
        ...
        <div style="float:right; width:625px;margin-top: 20px;">
            ...
            <table class="gernal_table manageListing" border="0" style="" width="50%" cellpadding="1" cellspacing="2">
                ...
                if(!empty($list)){
                    ...
                    if($i%2==0){
                        ...
                        <tr  class="MauveRow">
                            ...
                            ?>
                            <td onclick="DoNav('<?php echo Yii::app()->createUrl('listing/create/listid/'.$listData->user_default_listing_id);?>');" <?php if($i%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?> ><?php echo date('d-m-Y',strtotime($listData->user_default_listing_date));?></td>
                            ...
                            <td  onclick="DoNav('<?php echo Yii::app()->createUrl('listing/create/listid/'.$listData->user_default_listing_id);?>');" <?php if($i%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?> >Listing </td>
                ...
                $criteria1 = new CDbCriteria;
                $criteria1->compare('user_default_sample_listing_status', 0, true);
                $criteria1->join = "INNER JOIN user_default_listing AS listing ON (listing.user_default_listing_id = t.user_default_listing_id)";
                $criteria1->compare('listing.user_default_profiles_id', Yii::app()->user->getId(), true);
                $criteria1->order = 't.user_default_listing_id desc';
                $count = Samplelisting::model()->count($criteria1);
                ...
                if($count > 0)
                {
                    ...
                    if($i%2==0){
                        ...
                        <tr class="MauveRow"> <!--style="background-color: rgb(234, 221, 237);"-->
                            ...
                            ?>
                            <td  onclick="DoNav('<?php echo Yii::app()->createUrl('sample/sample_listing/listid/'.$listData1->user_default_listing_id);?>');" <?php if($i%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?>><?php echo date('d-m-Y',strtotime($samplemodel->user_default_sample_listing_date));?></td>
                            <td  onclick="DoNav('<?php echo Yii::app()->createUrl('sample/sample_listing/listid/'.$listData1->user_default_listing_id);?>');" <?php if($i%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?>><?php echo $listingmodel->user_default_listing_title;?></td>
                            <td  onclick="DoNav('<?php echo Yii::app()->createUrl('sample/sample_listing/listid/'.$listData1->user_default_listing_id);?>');" <?php if($i%2==0){  ?> onmouseover="ChangeColorGrey(this, true);" onmouseout="ChangeColorGrey(this, false);"  <?php }else {  ?> onmouseover="ChangeColorMauve(this, true);" onmouseout="ChangeColorMauve(this, false);"   <?php } ?> >Sample</td>
                            <td style="text-align: center; background-color: #fff" ><input type="hidden" value="<?php echo $samplemodel->user_default_sample_listing_id; ?>" name="del_samplenew" id="del_samplenew" /><a href="javascript:{}" onclick="delete_sampless<?php echo $i; ?>();" title="Delete this sample"  class="delbtnsamples<?php echo $i; ?>" id="delbtnnewsample"><img src="themes/business/images/icons/delete.gif" alt="Delete this listing"></a></td>
                        </tr>
                        <script>
                            function delete_sampless<?php echo $i; ?>()
                            {
                                jQuery(".delete_sample").fadeIn();
                                jQuery(".userlistings").fadeOut('fast');
                                var lid = $(".delbtnsamples<?php echo $i; ?>").parent().find('#del_samplenew').val();
                                $('#sample_delete_id').val(lid);
                            }
                        </script>
                        <?php
