        ...
        <div class="registration-content" style="min-height:337px">
            ...
            <table id="reg-table" style="width: 392px;">
                ...
                <tr>
                    ...
                    <td class="darkGrey-text"><a href="#;" style="background:none;" class="tooltip">Business sector<span class="classic">Please enter your business sector </span></a>
                    </td>
                    <td>
                        <label class="sector-con"></label>
                        <?php echo $form->dropDownList($model,'user_default_business_sector',CHtml::listData(ListingProfession::getAll(),'list_profession_id','list_profession_name'), array('prompt' => 'Please Select','tabindex'=>1,'class'=>'chzn-select')); ?>
                        <?php echo $form->error($model,'user_default_business_sector'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_name',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_name')); ?><span class="classic">Please enter your business name </span>
                        </a>
                    </td>
                    <td>
                        <?php echo $form->textField($model,'user_default_business_name',array('tabindex'=>2,'class'=>'inputfield')); ?>
                        <?php echo $form->error($model,'user_default_business_name'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field"></td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_slogon',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_slogon')); ?><span class="classic">Please enter your business slogon </span>
                        </a>
                    </td>
                    <td>
                        <?php echo $form->textField($model,'user_default_business_slogon',array('tabindex'=>3,'class'=>'inputfield')); ?>
                        <?php echo $form->error($model,'user_default_business_slogon'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_first_name',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_first_name')); ?><span class="classic">Please enter your first and second name</span>
                        </a>
                    </td>
                    <td>
                        <?php echo $form->textField($model,'user_default_business_first_name',array('tabindex'=>4,'class'=>'inputfield')); ?>
                        <?php echo $form->error($model,'user_default_business_first_name'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_surname',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_surname')); ?> <span class="classic">Please enter your last name</span>
                        </a>
                    </td>
                    <td>
                        <?php echo $form->textField($model,'user_default_business_surname',array('tabindex'=>5,'class'=>'inputfield')); ?>
                        <?php echo $form->error($model,'user_default_business_surname'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_title',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_title')); ?><span class="classic">Please enter your title, i.e Sole trader, Owner, Partnership, Director etc. </span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($model,'user_default_business_title',array('tabindex'=>6,'class'=>'inputfield')); ?>
                        <?php echo $form->error($model,'user_default_business_title'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_dob',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_dob')); ?> <span class="classic">You must be over 18 years of age to register</span> </a>
                    </td>
                    <td class="">
                        <?php $maxYear=date( 'Y') - 18; $yearRange="1900:$maxYear" ; $this->widget('zii.widgets.jui.CJuiDatePicker',array( 'name'=>'Business[user_default_business_dob]', 'model'=>$model->user_default_business_dob, 'flat'=>false, 'options'=>array( 'dateFormat' => 'd/m/yy', 'showAnim'=>'slideDown', 'changeMonth'=>true, 'changeYear'=>true, 'yearRange'=>$yearRange, 'minDate'=>'01/01/1900', 'maxDate' => date('t/').'12/'.$maxYear, 'defaultDate'=> date('d/m/').$maxYear, ), 'htmlOptions'=>array( 'placeholder'=>'DD / MM / YYYY ', 'tabindex'=>7, 'class'=>'inputfield', 'readonly'=>'readonly', ), )); ?>
                        <?php echo $form->error($model,'user_default_business_dob'); ?> </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_username',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_username')); ?> <span class="classic">Please use ALL lower case and no special characters, or spaces are allowed. <br>                                                      Only text and numbers.                                </span> </a>
                    </td>
                    <td>
                        <?php echo $form->textField($model,'user_default_business_username',array('tabindex'=>8,'class'=>'inputfield','onblur'=>'bussinesscheckdod();check_duplicate_username(this.value)','onfocus'=>'bussinesscheckdod();if(this.value=="Username already taken") this.value=""')); ?>
                        <?php echo $form->error($model,'user_default_business_username'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_email',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_email')); ?><span class="classic">Please enter your email address.</span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($model,'user_default_business_email',array('tabindex'=>9,'class'=>'inputfield','onblur'=>'check_duplicate_email(this.value)','onfocus'=>'if(this.value=="Email address already registered") this.value=""')); ?>
                        <?php echo $form->error($model,'user_default_business_email'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_pass',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_pass')); ?><span class="classic">Please enter your password</span>
                        </a>
                    </td>
                    <td>
                        <?php echo $form->passwordField($model,'user_default_business_pass',array('id'=>'Business_user_default_business_pass','class'=>'inputfield pass_icon','tabindex'=>10)); ?>
                        <input type="button" id="show-password" class="bpasschage" />
                        <?php echo $form->error($model,'user_default_business_pass'); ?> </td>
                </tr>
                <?php $Businessaddress=new Businessaddress; ?>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($Businessaddress,'user_default_business_addr1',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_addr1')); ?><span class="classic">Please enter your Address</span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($Businessaddress,'user_default_business_addr1',array('tabindex'=>11,'class'=>'inputfield')); ?>
                        <?php echo $form->error($Businessaddress,'user_default_business_addr1'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field"></td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($Businessaddress,'user_default_business_addr2',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_addr2')); ?><span class="classic">Please enter your Address</span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($Businessaddress,'user_default_business_addr2',array('tabindex'=>12, 'class'=>'inputfield')); ?>
                        <?php echo $form->error($Businessaddress,'user_default_business_addr2'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field"></td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($Businessaddress,'user_default_business_addr3',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_addr3')); ?><span class="classic">Please enter your Address</span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($Businessaddress,'user_default_business_addr3',array('tabindex'=>13, 'class'=>'inputfield')); ?>
                        <?php echo $form->error($Businessaddress,'user_default_business_addr3'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($Businessaddress,'user_default_business_town',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_town')); ?><span class="classic">Please enter your Town</span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($Businessaddress,'user_default_business_town',array('tabindex'=>14, 'class'=>'inputfield')); ?>
                        <?php echo $form->error($Businessaddress,'user_default_business_town'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($Businessaddress,'user_default_business_county',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_county')); ?><span class="classic">Please enter your county</span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($Businessaddress,'user_default_business_county',array('tabindex'=>15, 'class'=>'inputfield')); ?>
                        <?php echo $form->error($Businessaddress,'user_default_business_county'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($Businessaddress,'user_default_business_zip',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_zip')); ?><span class="classic">Please enter your zip</span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($Businessaddress,'user_default_business_zip',array('tabindex'=>16, 'class'=>'inputfield')); ?>
                        <?php echo $form->error($Businessaddress,'user_default_business_zip'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($Businessaddress,'user_default_business_country',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_country')); ?><span class="classic">Please select the country you live in</span>
                        </a>
                    </td>
                    <td>
                        ...
                        <?php echo $form->dropDownList($Businessaddress,'user_default_business_country',$data, array('prompt' => 'Please Select','tabindex'=>17,'class'=>'chzn-select')); ?>
                        <?php echo $form->error($Businessaddress,'user_default_business_country'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_phone',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_phone')); ?><span class="classic">Please enter your telephone no </span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($model,'user_default_business_phone',array('tabindex'=>18, 'class'=>'inputfield')); ?>
                        <?php echo $form->error($model,'user_default_business_phone'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field"></td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_fax',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_fax')); ?><span class="classic">Please enter your Mobile no </span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($model,'user_default_business_fax',array('tabindex'=>19, 'class'=>'inputfield')); ?>
                        <?php echo $form->error($model,'user_default_business_fax'); ?> </td>
                </tr>
                <tr>
                    <td class="mandatory-field">*</td>
                    <td class="darkGrey-text">
                        <a href="#;" style="background:none;" class="tooltip">
                            <?php echo $form->labelEx($model,'user_default_business_website',array('for'=>'Business_ttip_solution','rel'=>'Business_user_default_business_website')); ?><span class="classic">Please enter your website </span>
                        </a>
                    </td>
                    <td class="">
                        <?php echo $form->textField($model,'user_default_business_website',array('tabindex'=>20, 'class'=>'inputfield')); ?>
                        <?php echo $form->error($model,'user_default_business_website'); ?> </td>
                </tr>
            </table>    
