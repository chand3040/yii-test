...

{
 ...
 <img src='<?php echo Yii::app()->theme->baseUrl; ?>/images/blank.png' alt=''/> <img src='<?php echo Yii::app()->getBaseUrl(true); ?>/upload/sliders/big/$simg' alt='$desc' style='float: right;position: relative;overflow: hidden;height: 287px; margin-top: -295px;margin-right: 24px;' />
...

    {
       ...
       $('.home-slider-wrap').css('display','inline');
        ...
        ";
            ...
            $this->redirect(Yii::app()->createUrl('admin/website/slider'));
...

    {
        ...
        if (isset($_POST['Sliderlisting'])) {
            ...
            if ($model->save()) {
                ...
                $this->redirect(array('website/slider'));
