...
<style type="text/css">#div_upload_big {
...
<!--<a class="pu-close pu-close1" href="<?php /*echo Yii::app()->createUrl('/admin/website/slider/index'); */ ?>" title="Close"
   style="margin-right: 0px;">X</a>-->
...
<div>&nbsp;</div>
<div class="sl-basic-info pro-field" style="  width: 973px; margin-left:4px;">
    ...
    <?php echo $form->textField($model, 'slider_title', array('class' => 'inp width-500', 'id' => 'slider_title', 'style' => 'width:440px', 'onfocus' => "getNormal('#slider_title');")); ?>



    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Select
        page <a class="sl-tip tooltip" href="#;">?<span class="classic">Select the page you wish to allocate the slider to</span></a></label>&nbsp;&nbsp;&nbsp;
    ...
    <!-- <select class='chzn-select' name="Createsliderlisting[page_name]">
                                ...
                                <option value="businesslisting" <?php if ($model->page_name == "businesslisting") {
        echo "selected";
    } ?> >Business Listing</option>

                                <option value="business_services"<?php if ($model->page_name == "business_services") {
        echo "selected";
    } ?> >Business Services</option>

                                <option value="business_ideas" <?php if ($model->page_name == "business_ideas") {
        echo "selected";
    } ?> >Business-ideas</option>

                                <option value="indexpage"<?php if ($model->page_name == "indexpage") {
        echo "selected";
    } ?> >Index</option>

                                <option value="industrial"<?php if ($model->page_name == "industrial") {
        echo "selected";
    } ?> >Industrial</option>

                                <option value="retail"<?php if ($model->page_name == "retail") {
        echo "selected";
    } ?> >Retail</option>

                                <option value="science_and_technology"<?php if ($model->page_name == "science_and_technology") {
        echo "selected";
    } ?> >Science and Technology</option>

                                <option value="listing"<?php if ($model->page_name == "listing") {
        echo "selected";
    } ?> >User Listing</option>
...
<div style="margin-bottom: 3px;">
    ...
    <label style="color:#A47A8F;margin-left:4px">Upload photographs <a class="sl-tip tooltip" href="#;">?<span
                class="classic">Select and upload five images in one of the following formats:- BMP, JPEG, PNG, GIF<br> Please NOTE image size MUST NOT exceed 6"x4" otherwise cropping will occur.</span></a></label>
...
for ($i = 0; $i < 5; $i++) {
    ...
    <div class=" listing-upload photo-upload-box<?php echo $i; ?>" id="photo-upload-box-tab"
         style="height: 97%;width: 972px;margin-top: -100px;">

        <img class="side-robot-upload-slider"
             src="<?php echo Yii::app()->theme->baseUrl; ?>/images/robot/robot-upload.png"
             alt="Upload your business supermarket user profile picture"/>

        <div class="my-account-popup-box" id="upload-frame" style="height: auto; margin-top: -6px; text-align: center; width: 380px; ">

            <a class="pu-close" onclick='jQuery(".photo-upload-box<?php echo $i; ?>").hide();' href="javaScript:void(0)"
               title="Close">X</a>
                        ...
                        <?php $this->widget('ext.EAjaxUpload.EAjaxUpload',
                            ...
                            array(
                                ...
                                'config' => array(
                                    ...
                                    'action' => Yii::app()->createUrl('admin/website/slider/listingimage'),
    ...
    <div class="sl-photo-box" style="margin:0px; text-align:center">
        ...
        <div class="sl-photograph image_preview" id="image_preview<?php echo $i; ?>"
             style="width: 183px; overflow: hidden; height: 140px;">
            ...
            if ($imagename != "") {
                ...
                <img title="<?php echo $userimage[$i]->slider_imagedesc; ?>"
                     alt="<?php echo $userimage[$i]->slider_imagedesc; ?>"
                     src="<?php echo Yii::app()->baseUrl; ?>/upload/sliders/thumb/<?php echo $userimage[$i]->slider_image; ?>"
                     height="104"/>
        ...
        <div style="margin:10px 0 0 7px;">
            ...
            <a class="button gray" title="Upload logo" onClick="show_picture_form('photo-upload-box<?php echo $i; ?>')"
               href="javaScript:void(0)" id="uplaod-logo-<?php echo $i; ?>"> &nbsp; Select Image &nbsp;</a>
...
<div class="sl-image-description admin-description">
    ...
    <?php for ($i = 1; $i <= 5; $i++) { ?>
        ...
        <div class="img_desc img_desc_text">
            ...
            <textarea rows="2" cols="9" class="drg_imgdesc" name="slider_imagedesc[]"
                      id="image-description-<?php echo $i; ?>"><?php echo $userimage[$i - 1]['slider_imagedesc']; ?></textarea>
...
<div class="sl-image-description admin-description">
    ...
    <?php for ($i = 1; $i <= 5; $i++) { ?>
        ...
        <div class="img_desc img_desc_text">
            ...
            <input type="text" class="inp width" name="slider_sitelink[]" id="slider-sitelink-<?php echo $i; ?>"
                   value="<?php echo $userimage[$i - 1]['slider_sitelink']; ?>" style="background: none repeat scroll 0 0 #F1E5E2;
            ...
            <input type="text" class="inp width" name="slider_videolink[]" id="slider-videolink-<?php echo $i; ?>"
                   maxlength="80" value="<?php echo $userimage[$i - 1]['slider_videolink']; ?>" style="background: none repeat scroll 0 0 #F1E5E2;
...
<div class="slisting-head">
    ...
    <p>Button text for slider <a class="sl-tip tooltip" href="#;">?<span class="classic">Enter Content for 3 buttons besides the advertise slider . you can add button image , button text and add either site link or video link to each buttons.</span></a>
    </p>
...
?> <?php for ($i = 1; $i <= 3; $i++) { ?>
    ...
    <div class="sl-image-description admin-description">
        ...
        <h3 style="  color: #1dbfd8;margin-left:5px">Button <?php echo $i; ?></h3>

        <div class="img_desc img_desc_text" style="width:240px !important;">

            Button Image <br/>

            <input type="text" class="inp width" name="btn_image[]" id="btn_image_<?php echo $i; ?>"
                   value="<?php echo $userimage[$i - 1]['btn_image']; ?>" style="background: none repeat scroll 0 0 #F1E5E2;
        ...
        <div class="img_desc img_desc_text" style="width:233px !important;">
            ...
            <input type="text" class="inp width" name="btn_text[]" id="btn_text_<?php echo $i; ?>"
                   value="<?php echo $userimage[$i - 1]['btn_text']; ?>" style="background: none repeat scroll 0 0 #F1E5E2;
        ...
        <div class="img_desc img_desc_text" style="width:233px !important;">
            ...
            <input type="text" class="inp width" name="btn_sitelink[]" id="btn_sitelink_<?php echo $i; ?>"
                   value="<?php echo $userimage[$i - 1]['btn_sitelink']; ?>" style="background: none repeat scroll 0 0 #F1E5E2;
        ...
        <div class="img_desc img_desc_text" style="width:233px !important;">
            ...
            <input type="text" class="inp width" name="btn_videolink[]" id="slider-sitelink-<?php echo $i; ?>"
                   value="<?php echo $userimage[$i - 1]['btn_videolink']; ?>" style="background: none repeat scroll 0 0 #F1E5E2;
...
<div class="sl-bottom-buttons admin-button">
    ...
    <?php
        ...
        <a href="<?php echo Yii::app()->createUrl('/admin/website/slider/ldelete/id/' . $model->slider_id); ?>"
    ...
    <a href="<?php echo Yii::app()->createUrl('/admin/website/slider/index'); ?>" class="button black">Cancel</a>
