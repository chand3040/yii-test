...
<div class="user_listing_search content-container">
    ...
    <!--<a class="pu-close pu-close1" href="<?php /*echo Yii::app()->createUrl('/admin/department/index'); */ ?>" title="Close"
        ...
        <div class="form">
            ...
            <div class="sl-bottom-buttons admin-button" style="  margin-top: 200px !important;">
                ...
                <?php
                    ...
                    <a href="<?php echo Yii::app()->createUrl('/admin/website/department/ldelete/id/' . $model->dept_id); ?>"
                       class="button red">Delete</a>

                <?php
                }
                ?>
                <a href="<?php echo Yii::app()->createUrl('/admin/website/siteemails'); ?>"
