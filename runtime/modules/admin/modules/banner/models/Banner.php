 ...
 * @property string $user_default_listing_banner_duration
...

{
    ...
    public $listing_title_search;
    public $user_email_search;
...

    {
        ...
        return array(
            ...
            array('user_default_id, user_default_listing_banner_submission_date, user_default_listing_banner_path, user_default_listing_banner_duration, user_default_listing_banner_cost, user_default_listing_banner_link, user_default_listing_banner_clicks, user_default_listing_id', 'required'),
...

    {
        ...
        return array(
            ...
            'userDefault' => array(self::BELONGS_TO, 'User', 'user_default_id'),
...

    {
        ...
        $criteria->with = array('userDefault', 'userDefaultListing');

        $criteria->compare('userDefault.user_default_username', $this->user_name_search, true);
        ...
        $criteria->addSearchCondition('userDefault.user_default_username', $this->user_name_search);
        $criteria->addSearchCondition('userDefaultListing.user_default_listing_title', $this->listing_title_search);
        $criteria->addSearchCondition('userDefault.user_default_email', $this->user_email_search);
        ...
        $criteria->compare('user_default_listing_banner_duration', $this->user_default_listing_banner_duration, true);
            ...
            'sort' => array(
                'attributes' => array(
                    'user_name_search' => array(
                        'asc' => 'userDefault.user_default_username',
                        'desc' => 'userDefault.user_default_username DESC',
                    ),
                    '*',
                ),
            ),
