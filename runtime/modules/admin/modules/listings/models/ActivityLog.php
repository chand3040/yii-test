...
class ActivityLog extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('log_id, description, datetime', 'required'),
            array('user_default_id, user_default_business_id, log_id, counted_minutes', 'numerical', 'integerOnly' => true),
            array('id', 'length', 'max' => 20),
            array('description', 'length', 'max' => 255),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, user_default_id, user_default_business_id, log_id, description, datetime', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'user_default_business_id' => 'Business',
            'log_id' => 'Log',
