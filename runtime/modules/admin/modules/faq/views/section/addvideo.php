    ...
    <div class="row">
        <div class="">
            <div class="content-container box-full-area">
                <div class="sub-heading"><h2>Add video to faq</h2></div>
                <div class="all-sections"></div>
                <form id='section-form' enctype="multipart/form-data" action="<?php echo Yii::app()->createUrl('/admin/faq/section/addvideo');?>" method="post">
                    <?php
                        if(isset($m)){
                    ...
                    <p><input type="submit" name="submit" value="Create" class="button black black-btn"></p>
                </form>
            </div>
        </div>
    </div>
