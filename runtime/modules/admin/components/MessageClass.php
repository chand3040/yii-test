 ...
 *
 *
 * @name MessageClass : Common class for module configuration
...
class MessageClass extends CComponent
{
    ...
    public static $cOrderBy = 'user_default_date_create DESC';
    ...
    public static function renderPagination($viewLimitValue, $pageSelected, $commentOrderBy, $listingId, $userProfession)
    {
        ...
        $commentOrderBy = (isset($commentOrderBy)) ? $commentOrderBy : MessageClass::$commentOrderBy;

        $userProfession = (isset($userProfession)) ? $userProfession : MessageClass::$userProfession;
...
echo $sql .'4';
    ...
    public static function checkAdminKey($adminKey)
    {
        ...
        if (self::decryptString($adminKey) == MessageClass::$adminMail) {
