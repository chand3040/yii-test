...
<div class="user_listing_search">
    ...
    <a class="pu-close pu-close1" href="<?php echo Yii::app()->createUrl('/admin/mailtemplate/index'); ?>" title="Close"
            ...
            <div>
                ...
                <div class="sl-bottom-buttons admin-button" style="  margin-top: 200px !important;">
                    ...
                    <?php
                        ...
                        <a href="<?php echo Yii::app()->createUrl('/admin/department/ldelete/id/' . $model->dept_id); ?>"
                           class="button red">Delete</a>

                    <?php
                    }
                    ?>
                    <a href="<?php echo Yii::app()->createUrl('/admin/mailtemplate/index'); ?>" class="button black">Cancel</a>
