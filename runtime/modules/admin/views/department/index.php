...
<div class="user_listing_search"><br>
    ...
    <h2 align="center" class="Blue" style="margin:15px 0;">Add / Update Departments</h2>

    <div style="height: 39px;"><a href="<?php echo $this->createUrl('/admin/department/create'); ?>" class="button blue"
    ...
    <div>
        ...
        <div id="page_nav" class="art-page-nav">
            <table class="sl-select" id="example">
                <tr>
                    ...
                    <td>                              <?php if (isset($_REQUEST['rows'])) {
                            $count = $_REQUEST['rows'];
                        } else {
                            $count = 20;
                        } ?>                              <select name="drg_category" data-placeholder="12"
                                                                  class="chzn-select" style="width:60px;" tabindex="2"
        ...
        <!-- Bottom navigation menu -->                       <?php $this->widget('CLinkPager', array('pages' => $pages, 'header' => '', 'firstPageLabel' => '<', 'prevPageLabel' => 'previous', 'nextPageLabel' => 'next', 'maxButtonCount' => 5, 'lastPageLabel' => '>', 'htmlOptions' => array('name' => 'test', 'id' => 'navlist', 'class' => 'pager'))); ?>
