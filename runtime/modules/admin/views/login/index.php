                    ...
                    <table cellpadding="5" cellspacing="1" align="center" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <input style="cursor:pointer;" type="submit" class="button black-button" name="btnlogin"
                                       value="Login"/>&nbsp;&nbsp;

                                <input style="cursor:pointer;" type="reset"
                                       onclick="window.location='<?php echo $this->createAbsoluteUrl('/'); ?>';"
                                       class="button black-button" name="btncancel" value="Cancel"/>
