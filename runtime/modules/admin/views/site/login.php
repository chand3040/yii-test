...
if (Yii::app()->user->isGuest) {
    ...
    <div id="login-box"><!--lost password form-->
        <div id="login-area"><!--login form -->
            <form action="<?php echo Yii::app()->createUrl('user/login'); ?>" method="post" name="login_form"
                  id="login_form" onsubmit="return login_validation(this.form)"/>
            <?php //$form=$this->beginWidget('CActiveForm', array('id'=>'user-login-form','enableAjaxValidation'=>false,)); ?>

            <input onblur="if(this.value=='')this.value='Username'" onfocus="check_user_info(this.id);" type="text"
                   name="drg_username" title="Username"
                   value="<?php if (isset($_COOKIE['businesssupermaket']['username']) != '') {
                       echo $_COOKIE['businesssupermaket']['username'];
                   } else {
                       echo "Username";
                   } ?>" id="drg_username" size="20"/>

            <div id="passwordbox">
                <input type="<?php echo($_COOKIE['businesssupermaket']['password'] != '' ? "password" : "text"); ?>"
                       id="drg_pass" name="drg_pass"
                       value="<?php if (isset($_COOKIE['businesssupermaket']['password']) != '') {
                           echo $_COOKIE['businesssupermaket']['password'];
                       } else {
                           echo "Password";
                       } ?>" size="20" title="Enter your password" onfocus="check_pass_info(this.id);"
                       onblur="check_pass_out(this.id);"/>
            </div>
            ...
            <div class="sign-option">
                <ul>
                    <li>
                        <input type="checkbox" style="width:15px; float:right; margin-right:11px;" name="rememberme"
                               id="rememberme" value="1" <?php if (isset($_COOKIE['businesssupermaket']) != '') {
                    ...
                    <span class="buttons-box">
                        <button class="login_sbmt" name="login_sbmt" type="submit" title='Log into your account'><img
                                style="border-radius:5px; -moz-border-radius:5px; -o-border-radius:5px; -webkit-border-radius:5px;"
                                src="images/buttons/user.png" width="25"/></button>
                     </span>
                    </li>
                    <li><span>Lost your password</span>
                    <span class="buttons-box">
                        <a class="login_sbmt lpa" href="javaScript:void(0)" onclick="show_lost_pass_form()"
                           title='Reset your password'>
                            <img
                                style="border-radius:5px; -moz-border-radius:5px; -o-border-radius:5px; -webkit-border-radius:5px;"
                                src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/lost.png" width="25"/>
                        </a>
                     </span>
                    </li>
        ...
        <div id="lost_pass_request" style="display:none">
            <div id="lostpass-box">
                ...
                <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post" onsubmit="return false;">
                    <input onblur="if(this.value=='')this.value='Enter your Email address'"
                           onfocus="if(this.value=='Enter your Email address' || this.value=='Please enter your email' || this.value=='Email address does not exist')this.value=''"
                           onclick="if(this.value=='Enter your Email address')this.value=''" type="text"
                           name="drg_lost_email" id="drg_lost_email" title="Enter your Email address"
                           value="Enter your Email address" size="20"/>
        ...
        <div id="reset_success" style="display:none">
            <!--lost password form-->
            <div id="lostpass-box">
                <h3>Your password reset instructions have been sent to your email address. Please allow a few minutes to
                    receive the email.</h3>
    ...
    <div id="box2" class="lpb">
        <p class="click-here" id="reg_here">
            Click <?php echo CHtml::link('here', $this->createAbsoluteUrl('/register')); ?> to become a member and take
            part in our business community</p>
