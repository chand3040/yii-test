<div class="profile_activate_account" style="display: block; position: absolute; z-index: 2; top: 340px; left: 420px;">
                ...
                <table id="update-table" style="background-color:#f1e5e2">
                    ...
                    <tr>
                        <td><input type="text" value="User Account Activation Notice" class="value"
                                   id="notification_subject" name="activation_subject"></td>
                    </tr>
                    <tr>
                        <td class="label">Message <span class="mandatory-field">*</span></td>
                    </tr>
                    <tr>
                        <td><textarea id="notification_message" name="activation_message"
...
<script type="text/javascript">
    ...
    function notify_updation() {
        ...
        var URL = (userType == 'default_user') ? "<?php echo Yii::app()->baseUrl; ?>/admin/member/activate" : "<?php echo Yii::app()->baseUrl; ?>/admin/member/activateBusiness";
