...
<div class="row">
    <div class="col-1">
        ...
        $this->widget('zii.widgets.jui.CJuiDatePicker', array(
            'name' => 'Member[user_default_registration_date]',
            'model' => $model,
            'value' => CommonClass::convertDateAsDisplayFormat($model->user_default_registration_date, 'd/m/Y'),
            'options' => array(
                'dateFormat' => 'mm/dd/yy',
    ...
    <div class="col-1">
        ...
        <?php echo $form->dropDownList($model, 'user_default_account_status', array(0 => 'Not Active', 1 => 'Active', 2 => 'Suspend'), array('class' => 'chzn-select')); ?>
        <?php echo $form->error($model, 'user_default_account_status'); ?>
    </div>
    <div class="col-1">
        <label>Member since</label>
        <?php echo $form->textField($model, '', array('value' => CommonClass::convertDateAsDisplayFormat($model->user_default_registration_date, 'm/d/Y'), 'size' => 13)); ?>
        <?php echo $form->error($model, 'user_default_registration_date'); ?>
    </div>
    <div class="col-1">
        <label>Member type</label>
        <?php echo $form->textField($model, '', array('value' => ucwords($model->user_default_type), 'size' => 13, 'maxlength' => 50)); ?>
...
<div class="col-3" style="margin-left: -10px; margin-top: -12px;">
    ...
    <table style="border-spacing: 5px; padding: 0px;">
        ...
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($model, 'user_default_first_name', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($model, 'user_default_first_name', array('size' => 40, 'maxlength' => 50)); ?>
                <?php echo $form->error($model, 'user_default_first_name'); ?>
            </td>
        </tr>

        <tr>
            <td class="profile-label"><?php echo $form->labelEx($model, 'user_default_surname', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($model, 'user_default_surname', array('size' => 40, 'maxlength' => 50)); ?>
        ...
        <tr>
            ...
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->dropDownList($model, 'user_default_gender', array('m' => 'Male', 'f' => 'Female'), array('class' => 'chzn-select', 'style' => 'width:100px;')); ?>
                <?php echo $form->error($model, 'user_default_gender'); ?>
            </td>
        </tr>

        <tr>
            <td class="profile-label"><?php echo $form->labelEx($model, 'user_default_dob', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php
                $maxYear = date('Y') - 18;
        ...
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($model, 'user_default_username', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($model, 'user_default_username', array('size' => 40, 'maxlength' => 50)); ?>
                <?php echo $form->error($model, 'user_default_username'); ?>
            </td>
        </tr>
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($model, 'user_default_email', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($model, 'user_default_email', array('size' => 40, 'maxlength' => 100)); ?>
        ...
        // User Address
        $useraddress = Useraddress::model()->find(array(
        ...
        ?>
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($useraddress, 'user_default_address1', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($useraddress, 'user_default_address1', array('size' => 40, 'maxlength' => 500)); ?>
                <?php echo $form->error($useraddress, 'user_default_address1'); ?>
            </td>
        </tr>
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($useraddress, 'user_default_address2', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($useraddress, 'user_default_address2', array('size' => 40, 'maxlength' => 500)); ?>
                <?php echo $form->error($useraddress, 'user_default_address2'); ?>
            </td>
        </tr>
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($useraddress, 'user_default_address3', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($useraddress, 'user_default_address3', array('size' => 40, 'maxlength' => 500)); ?>
                <?php echo $form->error($useraddress, 'user_default_address3'); ?>
            </td>
        </tr>
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($useraddress, 'user_default_town', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($useraddress, 'user_default_town', array('size' => 40, 'maxlength' => 100)); ?>
                <?php echo $form->error($useraddress, 'user_default_town'); ?>
            </td>
        </tr>
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($useraddress, 'user_default_county', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($useraddress, 'user_default_county', array('size' => 40, 'maxlength' => 200)); ?>
                <?php echo $form->error($useraddress, 'user_default_county'); ?>
            </td>
        </tr>
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($useraddress, 'user_default_zip', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php echo $form->textField($useraddress, 'user_default_zip', array('size' => 40, 'maxlength' => 50)); ?>
                <?php echo $form->error($useraddress, 'user_default_zip'); ?>
            </td>
        </tr>
        <tr>
            <td class="profile-label"><?php echo $form->labelEx($useraddress, 'user_default_country', array('class' => 'field')); ?></td>
            <td class="spacer-colon">:</td>
            <td>
                <?php
                $data = CHtml::listData(Country::model()->findAll(), 'user_default_country_id', 'user_default_country_name');
                ?>
                <?php echo $form->dropDownList($useraddress, 'user_default_country', $data, array('prompt' => 'Please Select', 'class' => 'chzn-select', 'style' => 'width:224px')); ?>
                <?php echo $form->error($useraddress, 'user_default_country'); ?>
            </td>
        </tr>
        <tr>
...
<div class="col-4" style="margin-left: -10px;">
    <div class="row">
        ...
        $criteria3->addCondition('user_default_id=' . $model->user_default_id);
        $prizeWins = PrizeDrawWinners::model()->findAll($criteria3);

        $prizeWinsCount = 0;
        $prizeWonTotal = 0;
        if ($prizeWins) {
            $prizeWinsCount = count($prizeWins);
            foreach ($prizeWins as $price) {
                $prizeWonTotal += $price->prize_won_amount;
            }
        }
        ?>
        ...
        <div class="inner-col-1">
            ...
            <input type="text" value="<?php echo $prizeWinsCount ? $prizeWinsCount : ''; ?>"/>
        </div>
        <div class="inner-col-1">
            <label>Total won</label>
            <input type="text" value="<?php echo $prizeWonTotal ? '$' . $prizeWonTotal : ''; ?>"/>
        </div>
        <div class="inner-col-1">
    ...
    <div class="row">
        ...
        $criteria7->compare('user_default_profiles_id', $model->user_default_id, true);
        $listingsCount = count(Userlisting::model()->findAll($criteria7));
        ?>
    ...
    $criteria10->compare('user_default_profiles_id', $model->user_default_id, true);
    $criteria10->order = 'user_default_listing_submission_status desc,user_default_listing_id desc';

    $count = Userlisting::model()->count($criteria10);
    $pages = new CPagination($count);

    $pages->pageSize = 5;
    $pages->applyLimit($criteria10);

    $listings = Userlisting::model()->findAll($criteria10);
    if ($listings) {
        foreach ($listings as $index => $listing) {
            ...
            <div class="row">
                <div class="inner-col-1">
                    ...
                    <input type="text" name="Userlisting[user_default_listing_date]"
                           value="<?php echo CommonClass::convertDateAsDisplayFormat($listing->user_default_listing_date, 'm/d/Y'); ?>"/>
                </div>
                <div class="inner-col-1" style="width: 45%">
                    <?php if ($index == 0) { ?> <label>Title</label> <?php } ?>
                    <input type="text" name="Userlisting[user_default_listing_title]"
                           value="<?php echo $listing->user_default_listing_title; ?>"/>
                </div>
...
<div class="row">
    <div class="col-6">
        <label style="color: #a0688b !important; clear: both;">Admin Note</label><br/>
        <?php echo $form->textArea($model, 'user_default_admin_notes', array('rows' => 8, 'cols' => 158, 'style' => 'width:100%;')); ?>
