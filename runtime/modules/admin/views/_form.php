...
<div class="userData_btns">
    <div class="row buttons">
        ...
        if (!$model->isNewRecord) {
            ...
            <a href="<?php echo Yii::app()->createUrl('/admin/member/sendmail', array("id" => $model->drg_id)) ?>"
               class="button blue various ">Send Email</a>
            <?php

            if (strtolower($model->drg_status) == 'y') {
                ?>
                <a href="<?php echo Yii::app()->createUrl('/admin/member/suspend', array('id' => $model->drg_id)); ?>"
                   class="button pink">Suspend Account</a>
            <?php
            } else {
                ?>
                <a href="<?php echo Yii::app()->createUrl('/admin/member/activate', array('id' => $model->drg_id)); ?>"
                   class="button white">Activate Account</a>
            <?php
            }
            ?>
            <a href="<?php echo Yii::app()->createUrl('/admin/member/del', array('id' => $model->drg_id)); ?>"
