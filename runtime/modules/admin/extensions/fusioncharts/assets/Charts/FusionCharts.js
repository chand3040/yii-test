...
(function () {
    ...
    f.policies = {
        ...
        attributes: {lang: ['lang', 'EN'], 'class': ['className', 'FusionCharts']},
        width: ['width', '400'],
        height: ['height', '300'],
        src: ['swfUrl', ''],
        __state: {}
...
(function () {
    ...
    var E = {
        ...
        policies: {
            ...
            flashVars: {lang: ['lang', 'EN'], debugMode: ['debugMode', undefined], animation: ['animate', undefined]},
            options: {autoInstallRedirect: ['autoInstallRedirect', false]}
        },
        render: function (a, b) {
...
(function () {
    ...
    FCC.init = function () {
        var m = function (c, d, e) {
            ...
            combi: {'column2d': 'column', 'column3d': 'column', 'line': 'line', 'area': 'area'},
            valueAbs: {'Pie2D': true, 'Pie3D': true, 'Doughnut2D': true, 'Doughnut3D': true, 'Marimekko': true},
            exportFormat: {png: 'image/png', jpg: 'image/jpeg', pdf: 'application/pdf', svg: 'image/svg+xml'},
            JSONconf: {
                blankChart: {
                    chart: {events: {}, margin: [0, 0, 0, 0]},
                    credits: {
                    ...
                    title: {
                        ...
                        style: {fontFamily: 'Verdana', fontSize: '10px', color: '#666666'}
                    },
                    plotOptions: {series: {}},
        ...
        var K = function (a) {
            return {
                FCconf: {negative: false, stackValue: []},
                chart: {
                ...
                labels: {items: []},
                lang: {},
                legend: {enabled: true, symbolWidth: 5, borderRadius: 0, itemStyle: {}},
                loading: {},
                plotOptions: {
                    series: {
                        borderColor: '#333333',
                    ...
                    area: {
                        ...
                        marker: {lineWidth: 1, radius: 3, states: {hover: {enabled: false}, select: {enabled: false}}}
                    },
                    areaspline: {
                        states: {hover: {enabled: false}},
                        marker: {lineWidth: 1, radius: 3, states: {hover: {enabled: false}, select: {enabled: false}}}
                    ...
                    pie: {size: '80%', allowPointSelect: true, cursor: 'pointer'},
                    column: {}
                },
                point: {},
                series: [{}],
                ...
                xAxis: {
                    ...
                    }, categories: [], plotLines: [], plotBands: [], title: {style: {}, text: ''}
                },
                yAxis: [{
                    startOnTick: false,
                    endOnTick: false,
                ...
                exporting: {buttons: {exportButton: {}, printButton: {enabled: false}}}
            }
        };
                    ...
                    if (typeof b[y] === 'object') {
                        if (!b[y].vline) {
                            ...
                            a.data.push({
                                ...
                                } : (c === 7.5 ? {radius: b[y].z ? Math.round((b[y].z / h) * 10) / 10 : undefined} : null)
                            });
                            if (c < 2) {
...
(function () {
    ...
    var l = (function () {
        var e = {
            ...
            ins: {chart: true, map: true, graph: true},
            text: {dataset: 'data', categories: 'category'},
            group: {styles: {definition: true, application: true}}
        };
        ...
        var d = {
            items: {
                ...
                attr: {
                    ...
                    graph: {graph: 'graph', chart: 'graph'},
                    map: {map: 'map'},
                    linkedchart: {chart: 'chart', graph: 'graph', map: 'map'}
                },
                group: {styles: {definition: 'style', application: 'apply'}}
