...
CKEDITOR.lang.nb = {
    ...
    specialChar: {toolbar: 'Sett inn spesielt tegn', title: 'Velg spesielt tegn', options: 'Special Character Options'},
    link: {
    ...
    smiley: {toolbar: 'Smil', title: 'Sett inn smil', options: 'Smiley Options'},
    elementsPath: {eleLabel: 'Element-sti', eleTitle: '%1 element'},
    numberedlist: 'Nummerert liste',
    bulletedlist: 'Uordnet liste',
    indent: 'Øk nivå',
    outdent: 'Senk nivå',
    justify: {left: 'Venstrejuster', center: 'Midtjuster', right: 'Høyrejuster', block: 'Blokkjuster'},
    ...
    colordialog: {title: 'Velg farge', options: 'Color Options', highlight: 'Merk', selected: 'Valgt', clear: 'Tøm'},
