...
CKEDITOR.lang.pl = {
    ...
    textarea: {title: 'Właściwości obszaru tekstowego', cols: 'Kolumnu', rows: 'Wiersze'},
    textfield: {
    ...
    smiley: {toolbar: 'Emotikona', title: 'Wstaw emotikonę', options: 'Smiley Options'},
    elementsPath: {eleLabel: 'Elements path', eleTitle: 'element %1'},
