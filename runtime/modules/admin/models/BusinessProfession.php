...
/**
 * This is the model class for table "{{business_profession}}".
 *
 * The followings are the available columns in table '{{business_profession}}':
 ...
 */
class BusinessProfession extends CActiveRecord

{
...

    {
        ...
        return array(
            ...
            'businesses' => array(self::HAS_MANY, 'Business', 'user_default_business_sector'),
     ...
     * @return BusinessProfession the static model class
     */
