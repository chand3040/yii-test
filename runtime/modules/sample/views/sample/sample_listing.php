...
<div class="registration-box">
                        ...
                        <table align="center" width="100%">
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <button class="button black" title="Discard ALL data and close form" name="register" type="button" onclick="window.location.href = '<?php echo Yii::app()->createUrl('listing'); ?>'" >Discard</button>
                                </td>
                            </tr>
                        </table>
                    </div>
 ...
 <div class="sample-buttons-box"><span class="stext">Submit</span><button class="sample_submit" name="login_sbmt" type="submit" title="Log into your account"><img style="border-radius:5px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/user.png" width="25"></button>
                        ...
                        <div class="sample-buttons-box sl-bottom-buttons bottombtns">
                            ...
                            <button type="button" class="button black"  onclick="window.location.href = '<?php echo Yii::app()->createUrl('listing'); ?>'">Cancel</button>
                            <button type="button" class="button blue" id="savelater">Save for later</button>
                            <button type="submit" name="login_sbmt" id="login_sbmt" class="button update-green">Submit</button>
                        </div>
        ...
        <div style="float: right;width: 625px;font-size: 10px;">
            <?php
            $address = Samplelisting::model()->find("user_default_listing_id ='" . $model->user_default_listing_id . "'");
            $countsamples = count ( $address );
            ...
            $orders = Sampleorder::model()->findAll("user_default_sample_listing_id ='" . $address->user_default_sample_listing_id . "'" );
            $totalorders = count ( $orders );
            $outorders = Sampleorder::model()->findAll("user_default_sample_listing_id ='" . $address->user_default_sample_listing_id . "' and 	user_default_sample_listing_order_status = '1'" );
            $ordersout = count ( $outorders );
            $feeds = Samplefeedback::model()->findAll("user_default_sample_listing_id ='" . $address->user_default_sample_listing_id . "'" );
            $totalfeeds = count ( $feeds );
            $sql = "SELECT SUM(user_default_sample_listing_order_cost) as total_cost FROM {{sample_listing_orders}} where user_default_sample_listing_id = '".$address->user_default_sample_listing_id."' ";
            $totalComments = Yii::app()->db->createCommand($sql)->queryAll();
            $cost = $totalComments[0]['total_cost'];
            $reminderssent = $address->user_default_sample_listing_feedback_sent;
            $reminderlimit = "3";
            $reminderremain = $reminderlimit - $reminderssent;
            ...
            ?>
            <hr>
            <h2 class="samplesh2">Samples audit</h2>
            <div style="width:32%;display:inline-block;    vertical-align: top;">
                <table>
                    ...
                    <tr>
                        <td><label>Samples ordered:</label></td>
                        <td>
                            <input maxlength="50" class="sample_inner_textbox" id="" value="<?php echo $totalorders; ?>" style="font-size: 10px;margin-bottom: 5px;width: 74px;background: #ecdeed; border: none;" name="Samplelisting[user_default_sample_listing_cost]" type="text">
                        </td>
                    </tr>
                    <tr>
                        <td><label>Samples sent out:</label></td>
                        <td>
                            <input maxlength="50" class="sample_inner_textbox" id="" value="<?php echo $ordersout; ?>" style="font-size: 10px;margin-bottom: 5px;width: 74px;background: #ecdeed; border: none;" name="Samplelisting[user_default_sample_listing_cost]" type="text">
                        </td>
                    </tr>
                    <tr>
                        <td><label>Total cost:</label></td>
                        <td>
                            <input maxlength="50" class="sample_inner_textbox" id="" value="<?php echo $currency.$cost; ?>" style="font-size: 10px;margin-bottom: 5px;width: 74px;background: #ecdeed; border: none;" name="Samplelisting[user_default_sample_listing_cost]" type="text">
                        </td>
                    </tr>
                    <tr>
                        <td><label>Feedback received:</label></td>
                        <td>
                            <input maxlength="50" class="sample_inner_textbox" id="" value="<?php echo $totalfeeds; ?>" style="font-size: 10px;margin-bottom: 5px;width: 74px;background: #ecdeed; border: none;" name="Samplelisting[user_default_sample_listing_cost]" type="text">
                        </td>
                    </tr>
                    </tbody></table>
            </div>

            <div style="width:26%;display:inline-block;text-align:center;    vertical-align: top;">
    ...
    ?>
                ...
                <div class="starbardiv">
                    <table>
                        ...
                        <tr>
                            <td>5 star</td>
                            <td width="70%"><div class="starbar sbar">
                                    <div class="bar" style="width:<?php echo $rating5; ?>%"></div></div></td>
                            <td><?php echo is_null($countrating5[0]['ratings'])?0:$countrating5[0]['ratings']; ?></td>
                        </tr>
                        <tr>
                            <td>4 star</td>
                            <td><div class="starbar sbar">
                                    <div class="bar" style="width:<?php echo $rating4; ?>%"></div></div></td>
                            <td><?php echo is_null($countrating4[0]['ratings'])?0:$countrating4[0]['ratings']; ?></td>
                        </tr>
                        <tr>
                            <td>3 star</td>
                            <td><div class="starbar sbar">
                                    <div class="bar" style="width:<?php echo $rating3; ?>%"></div></div></td>
                            <td><?php echo is_null($countrating3[0]['ratings'])?0:$countrating3[0]['ratings']; ?></td>
                        </tr>
                        <tr>
                            <td>2 star</td>
                            <td><div class="starbar sbar">
                                    <div class="bar" style="width:<?php echo $rating2; ?>%"></div></div></td>
                            <td><?php echo is_null($countrating2[0]['ratings'])?0:$countrating2[0]['ratings']; ?></td>
                        </tr>
                        <tr>
                            <td>1 star</td>
                            <td><div class="starbar sbar">
                                    <div class="bar" style="width:<?php echo $rating1; ?>%"></div></div></td>
                            <td><?php echo is_null($countrating1[0]['ratings'])?0:$countrating1[0]['ratings']; ?></td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div style="width:40%;display:inline-block;text-align:center">
                <form action="<?php echo Yii::app()->createUrl('sample/sendreminder'); ?>" method="post">
                    <input type="hidden" name="currentlisting" value="<?php echo $address->user_default_listing_id; ?>">
                    ...
                    <table  style="text-align:center">
                        ...
                        <tr>
                            <td align=""><label>Samples sent out: <?php echo $ordersout; ?></td>
                        </tr>
                        <tr>
                            <td align=""><label>Total feedback received: <?php echo $totalfeeds; ?></td>
                        </tr>
                        <tr>
                            <td >
                                You may send a reminder email (up to 3 times) to sample recipients
                                that have not submitted a feedback
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <button type="submit" class="btn button blue">Send Reminder</button>
                            </td>
                        </tr>
                        <tr>
                            <td  style="text-align:center">
                                <input type="text" name="reminders" disabled value="<?php echo $reminderremain; ?>" style="text-align: center;width: 15px;" >
                            </td>
                        </tr>
                        </tbody>
                    </table>
        ...
        <tr>
            ...
            <td width="30%" valign="top">
                ...
                <div class="gray_box" style="padding: 10px;">
                    ...
                    <table width="100%">
                        <tr>
                            <td valign="middle" style="text-align:center !important"><a href='<?php if($address->user_default_sample_listing_att_specs){  echo Yii::app()->createUrl('/listing/viewpdf?filename='.$address->user_default_sample_listing_att_specs);} ?>' target="_blank"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/View-videos.png" style="padding-top: 12px;"/><br>View Online</a></td>
                    ...
                    <table width="100%">
                        <tr>
                            <td valign="middle" style="text-align:center !important"><a href='<?php if($address->user_default_sample_listing_att_instruction){  echo Yii::app()->createUrl('/listing/viewpdf?filename='.$address->user_default_sample_listing_att_instruction);} ?>' target="_blank"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/buttons/View-videos.png" style="padding-top: 12px;"/><br>View Online</a></td>
