...
class Businesslisting extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_default_business_slogon,user_default_business_whoweare,user_default_business_offer,user_default_business_category,user_default_business_profession,user_default_business_whatwecando,user_default_business_summary', 'required'),
			...
			array('user_default_business_blid, user_default_business_id, user_default_business_title, user_default_business_category, user_default_business_profession, user_default_business_viewlimit, user_default_business_slogon, user_default_business_summary, user_default_business_whoweare, user_default_business_offer, user_default_business_keyword, user_default_business_testimonial, user_default_business_datetime, user_default_business_status, user_default_business_lstatus, approved,user_default_business_whatwecando,user_default_business_last_page_visit,user_default_business_page_visit', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'user_default_business_title' => 'Company Name',
			...
			'user_default_business_summary' => 'Short Description',
	...
	public function search()
	{
		...
		$criteria->compare('user_default_business_summary',$this->user_default_business_summary,true);
