...
$stat ="Permenant Deleted";
 ...
 $yii_user_request_id = '<a href="'.Yii::app()->getBaseUrl(true)."/"."businesslisting/fupdate/blistid/".$model->user_default_business_blid.'" target="_blank" >here >> </a>';
		...
		if(isset($_POST['Businesslisting'])){
            ...
            if($model->save()){   
					...
					if($_POST['saveforlater'])
					{
						...
						$listingLink = '<a href="'.Yii::app()->getBaseUrl(true) . "/" .'businesslisting/view?id='.$blistid.'"> here >></a>';
						...
						$string = array(
							'{{#USERNAME#}}'=>$model_user['user_default_business_first_name'],
							'{{#LISTINGTITLE#}}'=>$model['user_default_business_title'],
							'{{#LISTINGDATE#}}'=>$model['user_default_business_datetime'],
							'{{#LISTINGSTATUS#}}'=>$model['user_default_business_status'],
	...
	public function actionIndex()
	{
        ...
        **/
		$this->pageTitle='Business Listing - Business Supermarket';
		$model = Businesslisting::model()->find("user_default_business_id ='".Yii::app()->user->getState('uid')."'");
