        ...
        <div class="my-account-popup-box">
            ...
            <div id="login1">
                ...
                <input onblur="if(this.value=='')this.value='Username'" onfocus="check_user_info(this.id);" type="text"
                       name="drg_username" title="Please enter your username"
                ...
                <div id="passwordbox">
                    ...
                    <input type="text" id="drg_pass" name="drg_pass" size="20" title="Plase enter your password"
                           onfocus="check_pass_info(this.id);" onblur="check_pass_out(this.id);"
                ...
                <div class="retrieve">
                    ...
                    <a class="login_sbmt lpa" href="javaScript:void(0)" onclick="show_lost_pass_form1()"
                ...
                <div id="lostpass-box">
                    ...
                    <form action="#" method="post" onsubmit="return false;">
                        ...
                        <div class="sign-option">
                            ...
                            <input class="button black" name="lostpass_sbmt" type="button" value="Submit"
                                   onclick="return lost_password1();"/>
            ...
            <div id="reset_success" style="display:none">
                ...
                <div id="lostpass-box">
                    ...
                    <h3>Your password reset instructions have been sent to your email address. Please allow a few
                        minutes to receive the email.</h3>
...
<style type="text/css">
    ...
    .login_box .u-email-box {
        width: 400px;
    }

    .login_box .u-email-box .my-account-popup-box {
        padding: 40px 24px;
    }

    .login_box .my-account-popup-box h4, #lost_pass_request h4 {
        font-size: 12px;
        font-weight: normal;
        padding-bottom: 10px;
    }
    ...
    .login_box .my-account-popup-box input[type="password"] {
        width: 94.5%;
        padding: 0 2%;
        height: 26px;
        line-height: 26px;
    ...
    .login_box #passwordbox {
        margin-top: 10px;
    }

    .login_box .my-account-popup-box .login_sbmt {
        width: 100%;
        text-align: right;
        margin-top: 5px;
    }

    .sign-option input[type="button"] {
