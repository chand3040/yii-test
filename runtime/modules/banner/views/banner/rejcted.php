...
<form action="<?php echo Yii::app()->createUrl("banner/update/"); ?>" method="post" id="bannerForm"
    ...
    <input type="text" class="uploader-field banner-input" placeholder="Please upload a new image " name="banner_link"
           id="banner_link" value=""/>
