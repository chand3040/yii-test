    ...
    */
    ...
    function renderChartHTML($chartSWF, $strURL, $strXML, $chartId, $chartWidth, $chartHeight, $debugMode = false, $registerWithJS = false, $setTransparent = "")
    {
        ...
        if ($pos === false) {
            ...
            <embed src="<?= $chartSWF ?>" FlashVars="<?= "$strFlashVars&registerWithJS=$nregisterWithJS" ?>"
                   quality="high" width="<?= $chartWidth ?>" height="<?= $chartHeight ?>"
                   name="<?= $chartId ?>" <? if ($this->JSC["bgcolor"] != "") print(" bgcolor=\"" . $this->JSC["bgcolor"] . "\""); ?>
                   allowScriptAccess="always" type="application/x-shockwave-flash"
                   pluginspage="<?= $HTTP ?>://www.macromedia.com/go/getflashplayer" wmode="<?= $nsetTransparent ?>"/>
