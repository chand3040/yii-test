...
(function () {
    ...
    function createElement(a, b, c, d, e) {
        ...
        if (e) {
            css(f, {padding: 0, border: NONE, margin: 0})
        }
        if (c) {
            css(f, c)
        }
    ...
    if (!globalAdapter && win.jQuery) {
        ...
        animate = function (a, b, c) {
            ...
            stop(a);
            effect = new Fx.Morph(d ? a : $(a), extend(c, {transition: Fx.Transitions.Quad.easeInOut}));
            effect.start(b);
            a.fx = effect
        };
        stop = function (a) {
    ...
    var z = {enabled: true, align: 'center', x: 0, y: 15, style: {color: '#666', fontSize: '11px'}};
    defaultOptions = {
        ...
        title: {text: 'Chart title', x: 0, y: 20, align: 'center', style: {color: '#3E576F', fontSize: '16px'}},
        ...
        plotOptions: {
            line: {
                ...
                showInLegend: true,
                states: {hover: {lineWidth: 3, marker: {}}, select: {marker: {}}},
                stickyTracking: true
            }
        },
    ...
    var A = {
        ...
        title: {rotation: 0}
    }, defaultTopAxisOptions = merge(defaultBottomAxisOptions, {labels: {y: -5}});
    var B = defaultOptions.plotOptions, defaultSeriesOptions = B.line;
    B.spline = merge(defaultSeriesOptions);
    B.scatter = merge(defaultSeriesOptions, {lineWidth: 0, states: {hover: {lineWidth: 0}}});
    ...
    B.bar = merge(B.column, {dataLabels: {align: 'left', x: 5, y: 0}});
    ...
    D.prototype = {
        init: function (a, b, c) {
            ...
            attr(d, {width: b, height: c, xmlns: 'http://www.w3.org/2000/svg', version: '1.1'});
            a.appendChild(d);
            ...
            return this.createElement('path').attr({d: a, fill: NONE})
        }, circle: function (x, y, r) {
            var a = typeof x == 'object' ? x : {x: x, y: y, r: r};
            ...
            return this.symbol('arc', x || 0, y || 0, r || 0, {innerR: a || 0, start: b || 0, end: c || 0})
            ...
            var e = typeof x == 'object' ? x : {x: x, y: y, width: mathMax(a, 0), height: mathMax(b, 0)};
            return this.createElement('rect').attr(extend(e, {rx: r || e.r, ry: r || e.r, fill: NONE}))
        }, g: function (a) {
            return this.createElement('g').attr(defined(a) && {'class': PREFIX + a})
        }, image: function (a, x, y, b, c) {
            var d = this.createElement('image').attr({x: x, y: y, width: b, height: c, preserveAspectRatio: NONE});
            ...
            if (path) {
                e = this.path(path);
                extend(e, {symbolName: b, x: x, y: y, r: c});
                if (d) {
                    extend(e, d)
                }
            } else if (imageRegex.test(b)) {
                imageSrc = b.match(imageRegex)[1];
                e = this.image(imageSrc).attr({visibility: HIDDEN});
                createElement('img', {
                    onload: function () {
            ...
            var c, id = PREFIX + idCounter++, clipPath = this.createElement('clipPath').attr({id: id}).add(this.defs);
            ...
            css = serializeCSS(b);
            e = {x: x, y: y, text: a, fill: fill, style: css.replace(/"/g, "'")};
            if (c || d != 'left') {
                e = extend(e, {
                    'text-anchor': {left: 'start', center: 'middle', right: 'end'}[d],
    ...
    if (!hasSVG) {
            ...
            init: function (a, b) {
                ...
                if (typeof b == 'string') {
                    ...
                    if (d == 'strokeWidth' || d == 'stroke-width') {
                        ...
                        ret = pick(this[d], parseInt(elemStyle[{x: 'left', y: 'top'}[d] || d], 10))
                    }
                } else {
                    for (d in b) {
                        value = b[d];
                        ...
                        if (symbolName && /^(x|y|r|start|end|width|height|innerR)/.test(d)) {
                            ...
                            elemStyle[{x: 'left', y: 'top'}[d]] = value
                        } else if (d == 'class') {
                ...
                ret = {x: a.offsetLeft, y: a.offsetTop, width: a.offsetWidth, height: a.offsetHeight};
                if (!hasOffsetWidth) {
                    if (origParentNode) {
                ...
                if (translateX || translateY) {
                    a.css({left: translateX, top: translateY})
                }
            }, shadow: function (a) {
        ...
        E.prototype = merge(D.prototype, {
            isIE8: userAgent.indexOf('MSIE 8.0') > -1, init: function (a, b, c) {
                this.width = b;
                this.height = c;
                this.box = createElement(DIV, null, {width: b + PX, height: c + PX}, a);
                this.Element = F;
                if (!u.namespaces.hcv) {
                ...
                return extend(e, {
                    members: [],
                    element: {style: {left: x, top: y, width: c, height: d}},
                    getCSS: function (a) {
                        var b = e.element.style, top = b.top, left = b.left, right = left + b.width, bottom = top + b.height, ret = {clip: 'rect(' + (a ? left : top) + 'px,' + (a ? bottom : right) + 'px,' + (a ? right : bottom) + 'px,' + (a ? top : left) + 'px)'};
                ...
                if (!c) {
                    e = this.createElement('span').attr({x: x, y: y - lineHeight, text: a});
                    elem = e.element;
                    elem.lineHeight = lineHeight;
                    css(elem, b);
                    if (d != 'left') {
                        spanWidth = e.getBBox().width;
                        css(elem, {left: (x - spanWidth / {right: 1, center: 2}[d]) + PX})
                    }
                } else {
                    ...
                    e = this.createElement('line').attr({from: x1 + ', ' + y1, to: x2 + ', ' + y2});
                    elem = e.element;
                    createElement('hcv:fill', {on: true, color: b.color}, null, elem);
                    createElement('hcv:path', {textpathok: true}, null, elem);
                ...
                var b, attribs;
                if (a) {
                    attribs = {'className': PREFIX + a, 'class': PREFIX + a}
                }
                b = this.createElement(DIV).attr(attribs);
                return b
            }, image: function (a, x, y, b, c) {
                return this.createElement('img').attr({src: a}).css({left: x, top: y, width: b, height: c})
            }, rect: function (x, y, a, b, r, c) {
                if (arguments.length > 1) {
                    var d = (c || 0) % 2 / 2;
                    x = mathRound(x || 0) + d;
                ...
                return this.symbol('rect', x || 0, y || 0, r || 0, {width: a || 0, height: b || 0})
                ...
                if (imageRegex.test(b)) {
                    d = this.createElement('img').attr({
                        onload: function () {
                            ...
                            css(a, {left: mathRound(x - size[0] / 2), top: mathRound(y - size[1] / 2)})
    ...
    function Chart(n, o) {
        ...
        function Axis(j, k) {
            ...
            function setExtremes(a, b, c) {
                c = pick(c, true);
                fireEvent(m, 'setExtremes', {min: a, max: b}, function () {
                    if (categories) {
                        if (a < 0) {
                            a = 0
                        }
            ...
            function getExtremes() {
                return {min: min, max: max, dataMin: dataMin, dataMax: dataMax}
            }
            ...
            function render() {
                ...
                if (!axisGroup) {
                    axisGroup = renderer.g('axis').attr({zIndex: 7}).add();
        ...
        function Toolbar(f) {
            ...
            function add(a, b, c, d) {
                if (!g[a]) {
                    var e = renderer.text(b, plotLeft + plotWidth - 20, plotTop + 30, n.toolbar.itemStyle, 0, 'right').on('click', d).attr({zIndex: 20}).add();
                    g[a] = e
                }
            }
        ...
        function Tooltip(c) {
            ...
            style.padding = 0;
            var e = renderer.g('tooltip').attr({zIndex: 8}).add(), box = renderer.rect(boxOffLeft, boxOffLeft, 0, 0, c.borderRadius, borderWidth).attr({
                fill: c.backgroundColor,
                'stroke-width': borderWidth
            }).add(e).shadow(c.shadow), label = renderer.text('', padding + boxOffLeft, parseInt(style.fontSize, 10) + padding + boxOffLeft).attr({zIndex: 1}).css(style).add(e);
            ...
            function refresh(a) {
                ...
                if (text === false || !show) {
                    ...
                    box.attr({width: boxWidth + 2 * padding, height: boxHeight + 2 * padding, stroke: borderColor});
        ...
        function MouseTracker(f, g) {
            ...
            function setDOMEvents() {
                ...
                container.onmousemove = function (e) {
                    ...
                    if (mouseIsDown) {
                        ...
                        if (zoomHor) {
                            var b = a - h;
                            selectionMarker.attr({width: mathAbs(b), x: (b > 0 ? 0 : b) + h})
                        }
                        if (zoomVert) {
                            var c = chartY - mouseDownY;
                            selectionMarker.attr({height: mathAbs(c), y: (c > 0 ? 0 : c) + mouseDownY})
                        }
                ...
                container.onclick = function (e) {
                    ...
                    if (!hasDragged) {
                        if (a && attr(e.target, 'isTracker')) {
                            ...
                            fireEvent(f.hoverSeries || a.series, 'click', extend(e, {point: a}));
            ...
            function createTrackerGroup() {
                ...
                if (inverted) {
                    trackerGroup.attr({width: f.plotWidth, height: f.plotHeight}).invert()
                }
                trackerGroup.attr({zIndex: 9}).translate(plotLeft, plotTop).add()
            }
            ...
            extend(this, {zoomX: zoomX, zoomY: zoomY, resetTracker: resetTracker})
        }
        ...
        var q = function (e) {
            ...
            function colorizeItem(a, b) {
                ...
                if (legendSymbol) {
                    legendSymbol.attr({stroke: symbolColor, fill: symbolColor})
                }
            }
            ...
            function renderItem(c) {
                ...
                if (!li) {
                    ...
                    if (simpleSymbol) {
                        ...
                        legendSymbol = renderer.symbol(c.symbol, -symbolWidth / 2 - symbolPadding, -4, c.options.marker.radius).attr(c.pointAttr[NORMAL_STATE]).attr({zIndex: 3}).add(legendGroup)
                    }
                    ...
                    if (c.options && c.options.showCheckbox) {
                        ...
                        addEvent(c.checkbox, 'click', function (a) {
                            var b = a.target;
                            fireEvent(c, 'checkboxClick', {checked: b.checked}, function () {
                                c.select()
                            })
                        })
                    }
            ...
            function renderLegend() {
                ...
                lastItemY = 0;
                if (!legendGroup) {
                    legendGroup = renderer.g('legend').attr({zIndex: 7}).add()
                }
                if (reversedLegend) {
                    series.reverse()
                }
                ...
                if (legendBorderWidth || legendBackgroundColor) {
                    ...
                    if (!box) {
                        ...
                        box.attr({height: boxHeight, width: boxWidth})
                    }
                }
                ...
                var d = getAlignment(extend({width: boxWidth, height: boxHeight}, f));
                legendGroup.translate(d.x, d.y);
                each(allItems, function (a) {
                    var b = a.checkbox;
                    if (b) {
                        css(b, {left: (d.x + a.legendItemWidth + b.x - 40) + PX, top: (d.y + b.y - 11) + PX})
                    }
                })
            }

            renderLegend();
            return {colorizeItem: colorizeItem, destroyItem: destroyItem, renderLegend: renderLegend}
        };
        ...
        function addSeries(a, b) {
            var c;
            b = pick(b, true);
            fireEvent(chart, 'addSeries', {options: a}, function () {
                c = initSeries(a);
                c.isDirty = true;
                chart.isDirty = true;
                if (b) {
        ...
        function showLoading(a) {
            var b = n.loading;
            if (!loadingLayer) {
                loadingLayer = createElement(DIV, {className: 'highcharts-loading'}, extend(b.style, {
                    left: plotLeft + PX,
                    top: plotTop + PX,
                    width: plotWidth + PX,
            ...
            if (!loadingShown) {
                ...
                animate(loadingLayer, {opacity: b.style.opacity}, {duration: b.showDuration});
                loadingShown = true
            }
        }

        function hideLoading() {
            animate(loadingLayer, {opacity: 0}, {
                duration: n.loading.hideDuration, complete: function () {
        ...
        function showTitle() {
            ...
            if (a && a.text) {
                renderer.text(a.text, anchorMap[titleAlign] + a.x, a.y, a.style, 0, titleAlign).attr({'class': 'highcharts-title'}).add()
            }
            if (subtitle && subtitle.text) {
                renderer.text(subtitle.text, anchorMap[subtitleAlign] + subtitle.x, subtitle.y, subtitle.style, 0, subtitleAlign).attr({'class': 'highcharts-subtitle'}).add()
            }
        }
        ...
        getAlignment = function (a) {
            ...
            if (/^(right|center)$/.test(b)) {
                ret.x = (chartWidth - a.width) / {right: 1, center: 2}[b] + optionsX
            }
            if (/^(bottom|middle)$/.test(vAlign)) {
                ret.y = (chartHeight - a.height) / {bottom: 1, middle: 2}[vAlign] + optionsY
            }
            return ret
        };
        ...
        function render() {
            ...
            if (plotBackgroundColor) {
                renderer.rect(plotLeft, plotTop, plotWidth, plotHeight, 0).attr({fill: plotBackgroundColor}).add().shadow(p.plotShadow)
            }
            ...
            if (labels.items) {
                each(labels.items, function () {
                    ...
                    delete a.left;
                    delete a.top;
                    renderer.text(this.html, x, y, a).attr({zIndex: 2}).add()
                })
            }
            each(series, function (a) {
                a.render()
    ...
    I.prototype = {
        ...
        animate: function (a) {
            ...
            if (a) {
                ...
                clipRect.animate({width: chart.plotSizeX}, {
                    complete: function () {
            ...
            if (a.options.marker.enabled) {
                ...
                while (i--) {
                    ...
                    if (plotY !== UNDEFINED) {
                        ...
                        radius = pointAttr.r;
                        if (graphic) {
                            graphic.attr({x: plotX, y: plotY, r: radius})
                        } else {
        ...
        getAttribs: function () {
            ...
            if (b.options.marker) {
                ...
                normalDefaults = {fill: seriesColor};
            ...
            if (this.options.dataLabels.enabled) {
                ...
                each(data, function (a) {
                    ...
                    if (seriesType == 'column') {
                        x += {center: a.barW / 2, right: a.barW}[align] || 0
                    }
                    if (str) {
        ...
        drawGraph: function (e) {
            ...
            if (useArea) {
                ...
                if (area) {
                    ...
                    f.area = f.chart.renderer.path(areaPath).attr({fill: fillColor}).add(f.group)
                }
            }
            if (graph) {
        ...
        render: function () {
            ...
            if (!a.group) {
                ...
                if (chart.inverted) {
                    group.attr({width: chart.plotWidth, height: chart.plotHeight}).invert()
                }
        ...
        setState: function (a) {
            ...
            if (b.state != a) {
                ...
                if (graph) {
                    graph.animate({'stroke-width': lineWidth}, a ? 0 : 500)
                }
            }
        },
        ...
        drawTracker: function () {
            var a = this, options = a.options, trackerPath = a.graphPath, chart = a.chart, snap = chart.options.tooltip.snap, tracker = a.tracker, cursor = options.cursor, css = cursor && {cursor: cursor}, singlePoints = a.singlePoints, singlePoint, i;
    ...
    SplineHelper.prototype = {
        get: function (a) {
            ...
            c[0] = this.xdata[0];
            d[0] = this.ydata[0];
            var e = [{plotX: c[0], plotY: d[0]}];
            for (var j = 1; j < a; j++) {
                c[j] = c[0] + j * b;
                d[j] = this.interpolate(c[j]);
                e[j] = {plotX: c[j], plotY: d[j]}
            }
            return e
    ...
    var N = extendClass(I, {
        type: 'spline', drawGraph: function (a) {
    ...
    var O = extendClass(N, {type: 'areaspline'});
    ...
    var P = extendClass(I, {
        ...
        translate: function () {
            ...
            each(data, function (a) {
                ...
                extend(a, {barX: b, barY: barY, barW: barW, barH: barH});
                a.shapeType = 'rect';
                a.shapeArgs = {x: b, y: barY, width: barW, height: barH, r: d.borderRadius};
                a.trackerArgs = defined(trackerY) && merge(a.shapeArgs, {height: 6, y: trackerY})
            })
        },
        getSymbol: function () {
        },
        ...
        drawTracker: function () {
            var c = this, chart = c.chart, renderer = chart.renderer, shapeArgs, tracker, trackerLabel = +new Date(), cursor = c.options.cursor, css = cursor && {cursor: cursor}, rel;
        ...
        animate: function (c) {
            ...
            if (!c) {
                each(data, function (a) {
                    var b = a.graphic;
                    if (b) {
                        b.attr({height: 0, y: d.yAxis.translate(0, 0, 1)});
                        b.animate({height: a.barH, y: a.barY}, {duration: 1000})
                    }
                });
                d.animate = null
            }
    ...
    var R = extendClass(I, {
        type: 'scatter', translate: function () {
            ...
            each(b.data, function (a) {
                a.shapeType = 'circle';
                a.shapeArgs = {x: a.plotX, y: a.plotY, r: b.chart.options.tooltip.snap}
            })
        }, drawTracker: function () {
            var c = this, cursor = c.options.cursor, css = cursor && {cursor: cursor}, graphic;
            each(c.data, function (b) {
                graphic = b.graphic;
                if (graphic) {
                    graphic.attr({isTracker: true}).on('mouseover', function (a) {
                        c.onMouseOver();
                        b.onMouseOver()
                    }).on('mouseout', function (a) {
                        if (!c.options.stickyTracking) {
    ...
    var S = extendClass(H, {
        init: function () {
            ...
            extend(a, {visible: a.visible !== false, name: pick(a.name, 'Slice')});
        ...
        drawPoints: function () {
            ...
            each(b.data, function (a) {
                ...
                if (!a.group) {
                    ...
                    a.group = renderer.g('point').attr({zIndex: 3}).add().translate(groupTranslation[0], groupTranslation[1])
                }
                if (graphic) {
                    graphic.attr(shapeArgs)
                } else {
...
(function () {
    ...
    defaultOptions.navigation = {
        ...
        menuItemStyle: {padding: '0 5px', background: NONE, color: '#303030'},
        ...
        getSVG: function (d) {
            ...
            if (!doc.createElementNS) {
                doc.createElementNS = function (a, b) {
                    ...
                    c.getBBox = function () {
                        return e.renderer.Element.prototype.getBBox.apply({element: c})
                    };
                    return c
                }
            }
            ...
            extend(options.chart, {renderTo: sandbox, renderer: 'SVG'});
            ...
            each(e.series, function (b) {
                ...
                seriesOptions.data = [];
                each(b.data, function (a) {
                    pointOptions = a.config == null || typeof a.config == 'number' ? {y: a.y} : a.config;
                    pointOptions.x = a.x;
            ...
            d = createElement('form', {method: 'post', action: b.url}, {display: NONE}, doc.body);
            each(['filename', 'type', 'width', 'svg'], function (a) {
                createElement('input', {
                    type: HIDDEN,
                    name: a,
                    value: {filename: b.filename || 'chart', type: b.type, width: b.width, svg: svg}[a]
                }, null, d)
            });
            d.submit();
            discardElement(d)
            ...
            if (!menu) {
                f[cacheName] = menu = createElement(DIV, {className: PREFIX + b}, {
                    position: ABSOLUTE,
                    zIndex: 1000,
            ...
            button = renderer.rect(buttonLeft, buttonTop, buttonWidth, buttonHeight, 0).attr({
                ...
                symbol.attr({stroke: btnOptions.hoverSymbolStroke, fill: btnOptions.hoverSymbolFill});
