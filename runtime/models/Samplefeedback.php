...
class Samplefeedback extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_default_sample_listing_feedback_id,user_default_sample_listing_id,user_default_profiles_id', 'numerical', 'integerOnly'=>true),
		    array('user_default_sample_listing_feedback_message', 'length', 'max'=>21845),
 			array('user_default_sample_listing_feedback_id,user_default_sample_listing_id, user_default_profiles_id, user_default_sample_listing_feedback_message, user_default_sample_listing_feedback_rating, user_default_sample_listing_feedback_date', 'safe', 'on'=>'search'),
		);
	}
